...
INSERT INTO user (user_id, user_name, user_password, account_type, user_phonenumber, user_email, gender, DoB, balance) VALUES
(1, 'nguyenvana', 'pass123A', 'ST', '0913123456', 'a.nguyen@gmail.com', 'male', '2005-05-01', 200.0),
(2, 'tranthib', 'pass123B', 'ST', '0709876543', 'b.tran@gmail.com', 'female', '2003-08-21', 150.0),
(3, 'leminhc', 'pass123C', 'NP', '0794567890', 'c.le@gmail.com', 'male', '1985-12-30', 300.0),
(4, 'phamthid', 'pass123D', 'NP', '0989988776', 'd.pham@gmail.com', 'female', '2001-04-15', 100.0),
(5, 'hoangtee', 'pass123E', 'ST', '0913789456', 'e.hoang@gmail.com', 'male', '1980-07-10', 0.0),
(6, 'vuquangf', 'pass123F', 'ST', '0836677889', 'f.vu@gmail.com', 'male', '2003-11-05', 220.0),
(7, 'ngothig', 'pass123G', 'NP', '0852233445', 'g.ngo@gmail.com', 'female', '1989-03-25', 180.0),
(8, 'buidinhh', 'pass123H', 'NP', '0791234987', 'h.bui@gmail.com', 'male', '2002-09-09', 90.0),
(9, 'maithii', 'pass123I', 'ST', '0705566778', 'i.mai@gmail.com', 'female', '2001-06-01', 130.0);
...
INSERT INTO bus_pass (pass_id, user_id, cart_id, pass_type, pass_price, pass_status_date, pass_expired_date, pass_status) VALUES
(1, 1, 1, 'Student_pass', 150000, '2025-04-01', '2025-05-01', 'active'),
(2, 2, 2, 'Student_pass', 150000, '2025-03-15', '2025-04-15', 'expired'),
(3, 3, 3, 'Normal_pass', 300000, '2025-03-01', '2025-04-01', 'expired'),
(4, 4, 4, 'Student_pass', 150000, '2025-04-10', '2025-05-10', 'active'),
(5, 5, 5, 'Normal_pass', 300000, '2025-04-05', '2025-05-05', 'active'),
(6, 6, 6, 'Student_pass', 150000, '2025-04-12', '2025-05-12', 'active'),
(7, 7, 7, 'Normal_pass', 300000, '2025-03-25', '2025-04-25', 'expired'),
(8, 8, 8, 'Student_pass', 150000, '2025-04-15', '2025-05-15', 'active'),
(9, 9, 9, 'Student_pass', 150000, '2025-04-20', '2025-05-20', 'active');

INSERT INTO ticket (ticket_id, user_id, cart_id, ticket_type, ticket_price, ticket_status_date, ticket_expired_date, ticket_status) VALUES
(1, 1, 1, 'Student_ticket', 3000, '2025-04-30', '2025-04-30', 'used'),
(2, 2, 2, 'Student_ticket', 3000, '2025-04-28', '2025-04-28', 'used'),
(3, 3, 3, 'Normal_ticket', 6000, '2025-04-20', '2025-04-20', 'expired'),
(4, 4, 4, 'Normal_ticket', 3000, '2025-04-29', '2025-04-29', 'used'),
(5, 5, 5, 'Normal_ticket', 6000, '2025-04-25', '2025-04-25', 'used'),
(6, 6, 6, 'Student_ticket', 3000, '2025-04-30', '2025-04-30', 'active'),
(7, 7, 7, 'Normal_ticket', 6000, '2025-04-27', '2025-04-27', 'used'),
(8, 8, 8, 'Student_ticket', 3000, '2025-04-26', '2025-04-26', 'used'),
(9, 9, 9, 'Normal_ticket', 3000, '2025-04-30', '2025-04-30', 'active');

INSERT INTO payment (payment_id, user_id, payment_method, payment_date, payment_status) VALUES
(1, 1, 'Credit Card', '2025-05-02', 'Completed'),
(2, 2, 'Momo', '2025-05-02', 'Cancelled'),
(3, 3, 'Debit Card', '2025-05-02', 'Completed'), 
(4, 4, 'Cash', '2025-05-02', 'Completed'),
(5, 5, 'Credit Card', '2025-05-02', 'Completed'),
(6, 6, 'Momo', '2025-05-02', 'Completed'),
(7, 7, 'Debit Card', '2025-05-02', 'Cancelled '),
(8, 8, 'Cash', '2025-05-02', 'Completed'),
(9, 9, 'Credit Card', '2025-05-02', 'Completed');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R008_G', 1, 1, 8, 'Route 8', 'Bến xe buýt Quận bus8', 'Bến xe buýt ĐH Quốc gia TPHCM', 32, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R008_R', 1, 1, 8, 'Route 8', 'Bến xe buýt Quận 8', 'Bến xe buýt ĐH Quốc gia TPHCM', 32, 'Return trip', 'a');
...
INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R010_G', 2, 2,  10, 'Route 10', 'Bến xe buýt ĐH Quốc gia TPHCM', 'Bến xe Miền Tây', 25, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R010_R', 2, 2,  10, 'Route 10', 'Bến xe buýt ĐH Quốc gia TPHCM', 'Bến xe Miền Tây', 25, 'Return trip', 'a');
...
INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R019_G', 3, 3, 19, 'Route 19', 'Bến xe buýt Sài Gòn', 'Bến xe buýt ĐH Quốc gia TPHCM ', 30, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R019_R', 3, 3, 19, 'Route 19', 'Bến xe buýt Sài Gòn', 'Bến xe buýt ĐH Quốc gia TPHCM ', 30, 'Return trip', 'a');
...
INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R033_G', 4, 4, 33, 'Route 33', 'Bến xe An Sương', 'Bến Xe Buýt ÐH Quốc Gia', 29, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R033_R', 4, 4, 33, 'Route 33', 'Bến xe An Sương', 'Bến Xe Buýt ÐH Quốc Gia', 29, 'Return trip', 'a');
...
INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R052_G', 5, 5, 52, 'Route 52', 'Bến xe buýt Sài Gòn', 'Bến xe buýt ĐH Quốc gia TPHCM', 22, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R052_R', 5, 5, 52, 'Route 52', 'Bến xe buýt Sài Gòn', 'Bến xe buýt ĐH Quốc gia TPHCM', 22, 'Return trip', 'a');
...
INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R053_G', 6, 6, 53, 'Route 53', 'Lê Hồng Phong', 'Bến Xe Buýt ÐH Quốc Gia', 32, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R053_R', 6, 6, 53, 'Route 53', 'Lê Hồng Phong', 'Bến Xe Buýt ÐH Quốc Gia', 32, 'Return trip', 'a');
...
INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R099_G', 7, 7, 99, 'Route 99', 'Khu dân cư Thạnh Mỹ Lợi', 'Bến Xe Buýt ÐH Quốc Gia', 26, 'Go trip', 'a');

INSERT INTO bus_route (route_id, pass_id, ticket_id, route_number, route_name, origin, destination, distance, direction, sequence_stop)
VALUES
('R099_R', 7, 7, 99, 'Route 99', 'Khu dân cư Thạnh Mỹ Lợi', 'Bến Xe Buýt ÐH Quốc Gia', 26, 'Return trip', 'a');
